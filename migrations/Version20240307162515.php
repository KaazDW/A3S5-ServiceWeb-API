 ...
 */
final class Version20240307162515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, date_commande DATE NOT NULL, status INT NOT NULL, client_id_id INT DEFAULT NULL, magasin_id_id INT DEFAULT NULL, horaire_id INT DEFAULT NULL, creneau_id INT DEFAULT NULL, INDEX IDX_6EEAA67DDC2902E0 (client_id_id), INDEX IDX_6EEAA67D2B2B9060 (magasin_id_id), INDEX IDX_6EEAA67D58C54515 (horaire_id), INDEX IDX_6EEAA67D7D0729A9 (creneau_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
